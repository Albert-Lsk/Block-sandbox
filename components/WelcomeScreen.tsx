    ...
    `}>
      <div className="text-center flex flex-col items-center gap-4 bg-slate-50/80 backdrop-blur-md p-8 rounded-3xl border border-slate-200 shadow-lg">
        ...
        <div className="space-y-3 mt-2">
            <p className="text-lg font-bold text-slate-700">构建神奇的体素模型</p>
            <p className="text-lg font-bold text-slate-700">打散它们并重新组装</p>
            <p className="text-lg font-bold text-slate-700">与朋友分享你的创意</p>
        </div>
      </div>
    </div>
  );
